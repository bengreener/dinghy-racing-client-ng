...
describe('when race is a pursuit race', () => {
    it('combines starts that are 15 seconds or less after the last start', () => {
        ...
        const baseWarningFlag = {name: 'Optimist (Club) Class Flag', role: FlagRole.WARNING, actions: []};
        const preparatoryFlag = {name: 'Blue Peter', role: FlagRole.PREPARATORY, actions: []};
        const cadetWarningFlag = {name: 'Cadet Class Flag', role: FlagRole.WARNING, actions: []};
        const rsTeraWarningFlag = {name: 'RS Tera Class Flag', role: FlagRole.WARNING, actions: []};
        const topper42WarningFlag = {name: 'Topper 4.2 Class Flag', role: FlagRole.WARNING, actions: []};
        const baseWarningFlagRaiseAction = {flag: baseWarningFlag, time: new Date(raceWithDinghyClasses.plannedStartTime.valueOf() - 300000), afterState: FlagState.RAISED};
        const baseWarningFlagLowerAction = {flag: baseWarningFlag, time: raceWithDinghyClasses.plannedStartTime, afterState: FlagState.LOWERED};
        const cadetWarningFlagRaiseAction = {flag: cadetWarningFlag, time: new Date(raceWithDinghyClasses.plannedStartTime.valueOf() - 60000 + 555000), afterState: FlagState.RAISED};
        const cadetWarningFlagLowerAction = {flag: cadetWarningFlag, time: new Date(raceWithDinghyClasses.plannedStartTime.valueOf() + 555000), afterState: FlagState.LOWERED};
        const rsTeraWarningFlagRaiseAction = {flag: rsTeraWarningFlag, time: new Date(raceWithDinghyClasses.plannedStartTime.valueOf() - 60000 + 555000), afterState: FlagState.RAISED}; // start is moved forward
        const rsTeraWarningFlagLowerAction = {flag: rsTeraWarningFlag, time: new Date(raceWithDinghyClasses.plannedStartTime.valueOf() + 555000), afterState: FlagState.LOWERED}; // start is moved forward
        const topper42WarningFlagRaiseAction = {flag: topper42WarningFlag, time: new Date(raceWithDinghyClasses.plannedStartTime.valueOf() - 60000 + 577000), afterState: FlagState.RAISED};
        const topper42WarningFlagLowerAction = {flag: topper42WarningFlag, time: new Date(raceWithDinghyClasses.plannedStartTime.valueOf() + 577000), afterState: FlagState.LOWERED};
        const preparatoryFlagRaiseAction = {flag: preparatoryFlag, time: new Date(raceWithDinghyClasses.plannedStartTime.valueOf() - 240000), afterState: FlagState.RAISED};
        const preparatoryFlagLowerAction = {flag: preparatoryFlag, time: new Date(raceWithDinghyClasses.plannedStartTime.valueOf() - 60000), afterState: FlagState.LOWERED};

        baseWarningFlag.actions.push(baseWarningFlagRaiseAction);
        baseWarningFlag.actions.push(baseWarningFlagLowerAction);
        cadetWarningFlag.actions.push(cadetWarningFlagRaiseAction);
        cadetWarningFlag.actions.push(cadetWarningFlagLowerAction);
        rsTeraWarningFlag.actions.push(rsTeraWarningFlagRaiseAction);
        rsTeraWarningFlag.actions.push(rsTeraWarningFlagLowerAction);
        topper42WarningFlag.actions.push(topper42WarningFlagRaiseAction);
        topper42WarningFlag.actions.push(topper42WarningFlagLowerAction);
        preparatoryFlag.actions.push(preparatoryFlagRaiseAction);
        preparatoryFlag.actions.push(preparatoryFlagLowerAction);

        const flags = raceStartSequence.getFlags(new Date(raceWithDinghyClasses.plannedStartTime.valueOf() - 660000));

        expect(flags).toEqual([baseWarningFlag, preparatoryFlag, cadetWarningFlag, rsTeraWarningFlag, topper42WarningFlag]);
    });
});