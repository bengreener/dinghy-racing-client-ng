...
import { httpRootURL, wsRootURL, raceScorpionA, entryChrisMarshallScorpionA1234 } from '../__mocks__/test-data';
...
describe('when race associated with signup is changed', () => {
    it('signup refreshes copy of race data', async () => {
        const model = new DinghyRacingModel(httpRootURL, wsRootURL);
        const newDate = new Date(raceScorpionA.plannedStartTime.getTime());
        newDate.setMinutes(45);
        const race_rescheduled = {...raceScorpionA, plannedStartTime: newDate};
        ...
        const signedup = new SignedUp(raceScorpionA, new Entry(entryChrisMarshallScorpionA1234.helm, entryChrisMarshallScorpionA1234.crew, entryChrisMarshallScorpionA1234.dinghy, entryChrisMarshallScorpionA1234.laps,
        ...
        await vi.waitFor(async () => {
            expect(signedup.race).toEqual(race_rescheduled);
        });        
