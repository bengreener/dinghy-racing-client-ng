...
const dinghyClassCollectionHAL = {
	'_embedded' : { 'dinghyClasses' : [ 
		{ 'name' : 'Scorpion', 'crewSize': 2, '_links' : { 'self' : { 'href' : 'http://localhost:8081/dinghyracing/api/dinghyclasses/1' }, 'dinghyClass' : { 'href' : 'http://localhost:8081/dinghyracing/api/dinghyclasses/1' } } }, 
		{ 'name' : 'Graduate', 'crewSize': 2, '_links' : { 'self' : { 'href' : 'http://localhost:8081/dinghyracing/api/dinghyclasses/5' }, 'dinghyClass' : { 'href' : 'http://localhost:8081/dinghyracing/api/dinghyclasses/5' } } }
	] }, '_links' : {
...
const racesCollectionHAL = {'_embedded':{'races':[raceScorpion_AHAL, raceGraduate_AHAL, raceNoClassHAL]},'_links':{'self':{'href':'http://localhost:8081/dinghyracing/api/races'},'profile':{'href':'http://localhost:8081/dinghyracing/api/profile/races'}},'page':{'size':20,'totalElements':3,'totalPages':1,'number':0}};
...
const entriesHAL = {'_embedded':{'entries':[
	{'_links':{'self':{'href':'http://localhost:8081/dinghyracing/api/entries/10'},'entry':{'href':'http://localhost:8081/dinghyracing/api/entries/10'},'dinghy':{'href':'http://localhost:8081/dinghyracing/api/entries/10/dinghy'},
		'competitor':{'href':'http://localhost:8081/dinghyracing/api/entries/10/competitor'},'laps':{'href':'http://localhost:8081/dinghyracing/api/entries/10/laps'},'race':{'href':'http://localhost:8081/dinghyracing/api/entries/10/race'}}},
	{'_links':{'self':{'href':'http://localhost:8081/dinghyracing/api/entries/11'},'entry':{'href':'http://localhost:8081/dinghyracing/api/entries/11'},'dinghy':{'href':'http://localhost:8081/dinghyracing/api/entries/11/dinghy'},
		'competitor':{'href':'http://localhost:8081/dinghyracing/api/entries/11/competitor'},'laps':{'href':'http://localhost:8081/dinghyracing/api/entries/11/laps'},'race':{'href':'http://localhost:8081/dinghyracing/api/entries/11/race'}}}
...
const dinghyClasses = [dinghyClassScorpion, dinghyClassGraduate];
const dinghyClassesByNameAsc = [dinghyClassGraduate, dinghyClassScorpion];
