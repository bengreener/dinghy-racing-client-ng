...
const raceScorpionA = { name: 'Scorpion A', plannedStartTime: new Date('2021-10-14T10:30:00Z'), dinghyClass: dinghyClassScorpion, duration: 2700000, type: 'FLEET', plannedLaps: 5, lapsSailed: 0, lapForecast: 5.0, lastLapTime: 0, averageLapTime: 0, clock: null, startSequenceState: 'NONE', url: 'http://localhost:8081/dinghyracing/api/races/4' };
const raceGraduateA = {name: 'Graduate A', plannedStartTime: new Date('2021-10-14T10:35:00Z'), dinghyClass: dinghyClassGraduate, duration: 2700000, type: 'FLEET', plannedLaps: 4, lapsSailed: null, lapForecast: 4.0, lastLapTime: null, averageLapTime: null, startSequenceState: 'NONE', clock: null, url: 'http://localhost:8081/dinghyracing/api/races/7' };
const raceCometA = {name: 'Comet A', plannedStartTime: new Date('2021-10-14T10:40:00Z'), dinghyClass: dinghyClassComet, duration: 2700000, type: 'FLEET', plannedLaps: 4, lapsSailed: null, lapForecast: 4.0, lastLapTime: null, averageLapTime: null, clock: null, startSequenceState: 'NONE', url: 'http://localhost:8081/dinghyracing/api/races/17' };
const raceHandicapA = {name: 'Handicap A', plannedStartTime: new Date('2021-10-14T10:45:00Z'), dinghyClass: null, duration: 2700000, type: 'FLEET', plannedLaps: 5, lapsSailed: null, lapForecast: 5.0, lastLapTime: 0, averageLapTime: 0, clock: null, startSequenceState: 'NONE', url: 'http://localhost:8081/dinghyracing/api/races/8' };
